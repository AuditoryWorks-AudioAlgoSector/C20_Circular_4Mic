...
int16_t rnnoise_samples[SAMPLE_RATE * SECONDS_PER_HOUR / MINUTES_PER_HOUR] = {0};
int16_t agc_samples[SAMPLE_RATE * SECONDS_PER_HOUR / MINUTES_PER_HOUR] = {0};
...
#if 0
int main_RNNOISE(int argc, char **argv) {
    int i;
    int first = 1;
    float x[FRAME_SIZE];
    FILE *f1, *fout;
