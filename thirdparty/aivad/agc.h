 ...
 */
#define SUBFRAMES 16
#define RXX_BUFFER_LEN SUBFRAMES
...
typedef struct {
    ...
    int32_t Rxx16w32_array[2][RXX_BUFFER_LEN/2];  // Energy values of microphone signal
    int32_t env[2][SUBFRAMES];            // Envelope values of subframes
